"""
A multi-webpage search for KOTN auction items that I commonly look for that opens a broswer page/ tab
with each search and yeilds upto 400 results per page.
...
search_list = open("/Users/HomeFolder/Virtual_Envs/KOTN_Search/list.txt", "r")
